...
const createObject = () => {
    ...
    txt = [
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(640, 380, 0)
        },
        {
            text: "Mercury",
            size: 5,
            height: 1,
            pos: new THREE.Vector3(698, 330, 0) // 58, 330, 0
        },
        ...
        // Venus
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(729, 330, 0) // 80, 330, 0
        },
        ...
        // Earth
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(740, 330, 0)
        },
        ...
        // Mars
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(770, 330, 0)
        },
        ...
        // Jupiter
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(815, 330, 0)
        },
        ...
        // Saturn
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(880, 330, 0)
        },
        ...
        // Uranus
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(920, 330, 0)
        },
        ...
        // Neptune
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(960, 330, 0)
        },
        ...
        // Satelite
        {
            ...
            size: 5,
            height: 1,
            pos: new THREE.Vector3(748, 330, 0)
        },
    ];
    ...
    saturnText = createText("Saturn", 5, 1, new THREE.Vector3(880, 330, 0));
...
const updatePlanet = () => {
    ...
    planets.forEach((planetGroup, index, txt) => {
        //delay logic
...
//     textList.forEach((planetGroup, index, txt) => {
//         //delay logic
//         if(currentTime > startTime + planetDelays[index]) {
//             //Update the angle based on the speed
//             planetAngles[index] -= planetSpeeds[index];
...
window.onmousemove = (event) => {
    ...
    window.addEventListener('mousemove', (event) => {
        ...
        if (intersects.length > 0) {
            ...
            intersects[0].object.material.color.set(textColor[Math.floor(Math.random() * 13)]);
